...
def move():
    ...
    #-Is it possible de move opponenent marble out of the board ? 
    #   -Yes : If different contact :
    #            Yes : Compute wich move will keep the most neighbour and move out opponnent marble with maximum marbles to do it
